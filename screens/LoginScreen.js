...
const LoginScreen = () => {
  ...
  return (
          <KeyboardAvoidingView>
           ...
           <View className={`bg-slatee-200 w-full h-full ${height < 300 ? 'py-2' : 'py-6'} `}>
      ...
      <Text className="text-2xl font-medium text-slate-700 text-center" >Sign In</Text>
          <View className="my-2">
           <Text className="text-slate-700 text-xl" > Username</Text>
      <Controller
        control={control}
        rules={{
          required: true,
      ...
      {errors.username && <Text className="text-red-500" >This is required.</Text>}
       ...
       <View className="my-2">
         <Text className="text-slate-700 text-xl" > Password</Text>
         <Controller
        control={control}
        rules={{
          required: true,
      ...
      {errors.password && <Text className="text-red-500">This is required.</Text>}
        ...
        <View>
            ...
            <Text className="font-medium text-slate-700 text-center" >Don't have an account ? </Text>
             ...
             >
                <Text className="text-xl font-medium text-red-400 text-center" >Sign Up</Text>
             </TouchableOpacity>
            </View>
        </View>
      </View>
